module ShoppingCart
  class CheckoutController < ApplicationController
    ...
    before_action :"authenticate_#{ShoppingCart.user_class.to_s.downcase}!"
    ...
    def update
      @checkout_form = CheckoutForm.new current_order: current_cart
    ...
    def set_default_delivery
      @default_delivery = current_cart.delivery
